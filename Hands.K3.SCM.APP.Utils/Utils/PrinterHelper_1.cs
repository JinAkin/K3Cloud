...
{
    public class PrinterHelper_1
    {
        private PrinterHelper_1() { }
        #region API声明
        ...
        public static System.Collections.ArrayList GetPrinterList(PrinterEnumFlags flag)
        {
            System.Collections.ArrayList alRet = new System.Collections.ArrayList();
            PRINTER_INFO_2[] Info2 = EnumPrintersByFlag(flag);
        ...
        public static bool PrinterInList(string PrinterName, PrinterEnumFlags flag)
        {
            bool bolRet = false;

            System.Collections.ArrayList alPrinters = GetPrinterList(flag);
