                    ...
                    if (notice != null)
                    {
                        if (notice.TraceEntry != null && notice.TraceEntry.Count > 0)
                        {
                            foreach (var trace in notice.TraceEntry)
                            {
                                if (trace != null)
                                {
                                    TrackRequest request = CreateTrackRequest(trace.F_HS_CarryBillNO);
                                    LogXML("trackingNumber:["+ trace.F_HS_CarryBillNO + "]  Request",request,typeof(TrackRequest));
                                    //
                                    ...
                                    try
                                    {
                                        ...
                                        LogXML("trackingNumber:[" + trace.F_HS_CarryBillNO + "]  Reply", reply, typeof(TrackReply)); 
